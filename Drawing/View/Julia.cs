...
namespace Drawing
{
    public partial class Julia : Form
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            Directory.CreateDirectory(@"C:\Users\" + userName + "\\julia_config\\Undo\\");
            Array.ForEach(Directory.GetFiles(@"c:\Users\" + userName + "\\julia_config\\Undo\\"), File.Delete);

            // Initialize undo.
            StreamWriter writer = new StreamWriter(@"C:\Users\" + userName + "\\julia_config\\Undo\\undo" + (undoNum -= 1) + ".txt");
            writer.Write(
        ...
        private void RenderImage()
        {
            try
            {
                ...
                for (double y = yMin; y < yMax; y += xyStep.y)
                {
                    ...
                    lineNumber++;
                    if ((lineNumber % 200) == 0)
                    { // how fast the screen is refreshing
                        Refresh();
                    }
                }
                ...
                StreamWriter writer = new StreamWriter(@"C:\Users\" + userName + "\\julia_config\\Undo\\undo" + undoNum + ".txt");
        ...
        /// <summary>
        /// On-click handler for main pictureCreating. Defines the points (lower-left and upper-right)
        /// of a zoom rectangle.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Mouse-up handler for main pictureCreating. The coordinates of the rectangle are
        ...
        private void Julia_Paint(object sender, PaintEventArgs e)
        {
